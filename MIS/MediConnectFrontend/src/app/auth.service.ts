...
export class AuthService {
  ...
  registerUser(first_name: string, last_name: string, email: string, password: string, role: string, security_question: string, security_answer: string): void {
    const registrationUrl = `${this.baseUrl}/api/register/`;
    const user = { first_name, last_name, email, password, role, security_question, security_answer };
